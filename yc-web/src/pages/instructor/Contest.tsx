...
import { Search, Plus, Pencil, Trash2, Eye, Trophy, Users, Calendar, Building2, GraduationCap, Zap, Clock, CalendarIcon, Settings } from 'lucide-react';
...
export default function OwnerContest() {
  ...
  const handleAddContest = async () => {
    const payload = {
      ...
      duration: formData.duration ? parseInt(formData.duration) * 60 : undefined, // expects seconds
      ...
      <div className="flex">
        ...
        <div className="flex-1">
          <RoleHeader
            ...
            subtitle="Create and manage coding contests for students"
          />
          <div className="p-6">
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-2">
                              <Button
                                ...
                                title="Manage Contest Questions"
                              >
