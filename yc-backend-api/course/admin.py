...
class VideoAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['id', 'created_at', 'updated_at']
    fields = ['title', 'sub_topic', 'video_link', 'ai_context', 'id', 'created_at', 'updated_at']
...
class CodingProblemAdmin(admin.ModelAdmin):
    ...
    list_display = ['title', 'sub_topic', 'created_at', 'updated_at']
    list_filter = ['sub_topic__topic__course', 'sub_topic__topic', 'created_at']
    search_fields = ['title', 'description', 'sub_topic__name', 'sub_topic__topic__name']
    readonly_fields = ['id', 'created_at', 'updated_at']
    fields = ['title', 'sub_topic', 'description', 'input', 'test_cases', 'id', 'created_at', 'updated_at']
    ordering = ['sub_topic', 'created_at']
...
class QuizAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ['question_preview', 'sub_topic', 'correct_answer_display', 'created_at', 'updated_at']
    list_filter = ['sub_topic__topic__course', 'sub_topic__topic', 'created_at']
    search_fields = ['question', 'sub_topic__name', 'sub_topic__topic__name']
    readonly_fields = ['id', 'created_at', 'updated_at']
    fields = ['question', 'sub_topic', 'options', 'correct_answer_index', 'id', 'created_at', 'updated_at']
    ordering = ['sub_topic', 'created_at']
...
class NoteAdmin(admin.ModelAdmin):
    ...
    search_fields = ['content', 'user__username', 'user__email', 'sub_topic__name', 'sub_topic__topic__name']
    readonly_fields = ['id', 'created_at', 'updated_at']
