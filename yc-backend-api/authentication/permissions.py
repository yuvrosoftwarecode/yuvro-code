...
class IsContentAdminOrAdmin(permissions.BasePermission):
    """
    Permission class that allows access to content admins and admins.
    """
...
class CanManageContent(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        # Write permissions only for content admins and admins
