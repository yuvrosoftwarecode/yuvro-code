      ...
      <div className="p-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 text-sm mb-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-gray-800">{continueProgress.course_name || "Course"}</span>
              </div>
            ...
            <div className="relative w-full h-3 mb-6 rounded-full overflow-hidden bg-gradient-to-r from-blue-200 to-cyan-200 shadow-inner">
              <div
                className="absolute top-0 left-0 h-full rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 transition-all duration-300"
                style={{ width: `${Math.max(0, Math.min(100, continueProgress.percent))}%` }}
              />
            </div>
          </div>
          ...
          <Button
            ...
            onClick={() => onContinue(continueProgress.course_id)}
          >
            Continue Learning
          </Button>
        </div>
