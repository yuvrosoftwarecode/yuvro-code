        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">{test.course}</p>
            </div>
            <Badge 
              variant="outline" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center space-x-3 p-4 bg-muted/30 rounded-lg">
              ...
              <div>
                ...
                <p className="font-semibold">{test.marks}</p>
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li className="flex items-start space-x-2">
                  <span className="text-primary">•</span>
                  <span>Submit your test before time expires</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-primary">•</span>
        ...
        <CardContent>
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-orange-800">
                ...
                <p>This test uses automated proctoring to ensure academic integrity. Please ensure compliance with all monitoring requirements.</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-start space-x-3 p-3 border rounded-lg">
              ...
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">Keep your camera on and face visible throughout the test</p>
              </div>
            </div>
          ...
          <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
            ...
            <ul className="text-sm text-red-700 space-y-1">
              ...
              <li>• Taking screenshots or recording the test</li>
              <li>• Leaving the test area</li>
            </ul>
          </div>
        </CardContent>
      </Card>
