  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-white border border-gray-200 shadow-2xl sm:rounded-2xl p-6",
        "opacity-0 scale-95 data-[state=open]:opacity-100 data-[state=open]:scale-100",
        "transition-transform transition-opacity duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
        className
      )}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md opacity-70 hover:opacity-100 transition focus:outline-none focus:ring-2 focus:ring-indigo-500">
        <X className="h-4 w-4" />
